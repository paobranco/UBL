...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in AdasynClassif(Class \textasciitilde{} ., ImbC, C.perc = list(normal = 0.4, rare1 = 8, : unused argument (C.perc = list(normal = 0.4, rare1 = 8, rare2 = 6))}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in AdasynClassif(Class \textasciitilde{} ., ImbC, dist = "{}HVDM"{}, C.perc = list(normal = 0.2, : unused argument (C.perc = list(normal = 0.2, rare1 = 10))}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in AdasynClassif(Class \textasciitilde{} ., ImbC, dist = "{}HVDM"{}, C.perc = "{}extreme"{}): unused argument (C.perc = "{}extreme"{})}}\end{kframe}
\end{knitrout}
